...
namespace Void2610.LiminalPalette
{
    ...
    ///
    /// インスタンスメソッドの場合は VContainer 経由で解決される (ConsoleCommand と同じ流儀)。
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, Inherited = false, AllowMultiple = false)]
    public sealed class ConsoleScenarioAttribute : Attribute
    {
        ...
        public ConsoleScenarioAttribute(string path) => Path = path;
    }
}
